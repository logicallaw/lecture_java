...
21.interface 상속받는 interface
-->implements가 아닌 extends를 사용한다.


#궁금한 점
1.abstract 클래스 내부에서
추상 메서드 없어도 가능?->가능. 추상클래스지만 추상메서드 없어도 가능.

2.추상메서드면 body의 내용이 반드시 없어야됨?->{}도 있으면 안됨.
무조건 선언만 해야됨.


#몰랐던 개념 정리
1.this.x = this.y = 0;이런 문법도 가능하다.
2.인터페이스 상속받는 자식클래스에서
오버라이딩할 때 접근 제한자도 꼭 붙어야한다.안그러면 에러다.
